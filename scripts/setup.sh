...
twilio phone-numbers:update $TWILIO_NUMBER  --sms-url=$SMS_ENDPOINT_URL -o=json
echo "Number updated with new function URL..."

twilio api:core:messages:create --from=$TWILIO_NUMBER --to=$MY_PHONE_NUMBER --body="Hello $MY_NAME. Happy to have you. Send '/help' to see all commands in your new SMS group chat."
